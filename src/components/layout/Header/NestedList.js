        ...
        >
          <li>
            <ul>
              ...
              <li>
                <Link to={"catalog/decor"}>Пуфы и банкетки</Link>
              </li>
            </ul>
          </li>
          <li>
            <ul>
              <li>
                <Link to={"catalog/decor"}>Кресла</Link>
              </li>
              <li>
                <Link to={"catalog/decor"}>Стулья</Link>
              </li>
            </ul>
          </li>
          <li>
            <ul>
              ...
              <li>
                <Link to={"catalog/decor"}>Постельное белье</Link>
              </li>
            </ul>
          </li>
          <li>
            <ul>
              ...
              <li>
                <Link to={"catalog/decor"}>Шторы</Link>
              </li>
            </ul>
          </li>
        </ul>
