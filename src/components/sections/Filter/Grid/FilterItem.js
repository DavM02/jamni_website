        ...
        <div className="filter-item"
            ...
            {item ? (
                <div className='placeholder'
                    style={{ height: el === 'l' ? 'calc(var(--filter-item-img-height) * 2 + 125px)' : 'var(--filter-item-img-height)' }}>
                    <LazyLoadImage
                        effect="opacity"
                        height={'inherit'}
                        width="100%"
            ...
            <span className='xxxsmall-text text-main'>{item.price.toLocaleString('ru-RU')} руб.</span>
